...
<h3 style="text-align: center;color:red">INFORMATION</h3>
        ...
        $find="SELECT COUNTRY FROM COUNTRIES WHERE COUNTRY_ID like :country_id";
       ...
       <h3 style="text-align:center;color:red">EDUCATION</h3>
            ...
            <table align="center">
              <tr><td><label>Academic level:</label></td><td><p> <?php $email=$_SESSION['email'];
        ...
        if(oci_execute($run)){
          ...
          ?></p></td></tr>
              <tr><td><label>School Name:</label></td><td><p><?php $email=$_SESSION['email'];
           $sel="SELECT ID FROM USERS WHERE EMAIL='$email'";
        $kqq=oci_parse($conn,$sel);
        oci_execute($kqq);
        $idus=0;
     ...
     <h3 style="color:red;text-align:center">KINH NGHIỆM</h3>
            ...
            <table align="center">
              <tr><td><label>Tên công ty:</label></td><td><p>
        ...
        while($row=oci_fetch_row($kqq)){
          ...
          echo $value;
             ...
             ?></p></td></tr>
             <tr><td><label>Mức lương gần nhất:</label></td><td><p><?php
                 $email=$_SESSION['email'];
           $sel="SELECT ID FROM USERS WHERE EMAIL='$email'";
           $kqq=oci_parse($conn,$sel);
           oci_execute($kqq);
        ...
        while($row=oci_fetch_row($kqq)){
          ...
          echo $value;?>
            ...
            <tr><td><?php if(isset($_GET['email'])){$em=$_GET['email']; echo'<a href="guiemail.php?email='.$em.'">Gửi</a>'; ;}else{
